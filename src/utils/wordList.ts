...
const WORD_LIST = [
  ...
  'black', 'blame', 'blank', 'blast', 'blind', 'block', 'blood', 'blown', 'blues', 'board',
  ...
  'realm', 'rebel', 'refer', 'relax', 'renew', 'reply', 'right', 'rigid', 'rival', 'river',
  ...
  'sight', 'simon', 'sixth', 'sixty', 'sized', 'skill', 'sleep', 'slide', 'small', 'smart',
  'smile', 'smith', 'smoke', 'snake', 'snow', 'social', 'solid', 'solve', 'sorry', 'sound',
  ...
  'taste', 'taxes', 'teach', 'teams', 'terry', 'texas', 'thank', 'theft', 'their', 'theme',
  'there', 'these', 'thick', 'thing', 'think', 'third', 'those', 'three', 'threw', 'throw',
  'thumb', 'tiger', 'tight', 'times', 'tired', 'title', 'today', 'token', 'topic', 'total',
  'touch', 'tough', 'tower', 'track', 'trade', 'train', 'treat', 'trend', 'trial', 'tribe',
  'trick', 'tried', 'tries', 'truck', 'truly', 'trunk', 'trust', 'truth', 'twice', 'twist',
  'typed', 'uncle', 'under', 'undue', 'union', 'unity', 'until', 'upper', 'upset', 'urban',
